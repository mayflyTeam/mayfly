  ...
  return (
      <nav className="flex font-prompt bg-white w-screen h-24 items-center text-red-900 justify-between border-b-4 border-b-gray-900">
          ...
          <ul className="flex mr-auto text-xl">
            <li className="m-2 underline text-red-700 cursor-pointer">Home</li>
            <Link to="/dashboard"><li className="m-2 hover:underline hover:text-red-500 cursor-pointer">Dashboard</li></Link>
